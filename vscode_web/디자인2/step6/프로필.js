...
const homeContactBtn = document.querySelector(".intro__contact");
...
*/
const home = document.querySelector(".intro__container");
...
workBtnContainer.addEventListener("click", (e) => {
  const filter =
    ...
    e.target.parentNode.dataset
      .filter; /* ||뒤에 조건은 버튼안에 숫자를 눌렀을 때 값을 받기 */
  //console.log(filter);
